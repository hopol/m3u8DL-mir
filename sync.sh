#!/usr/bin/env bash
# 手动镜像 nilaoda/N_m3u8DL-RE 的 main 分支。
set -euo pipefail

UPSTREAM_URL="https://github.com/nilaoda/N_m3u8DL-RE.git"
UPSTREAM_WEB_URL="https://github.com/nilaoda/N_m3u8DL-RE"
UPSTREAM_BRANCH="main"
MIRROR_REPO="https://github.com/hopol/m3u8DL-mir"
...
git add upstream
git commit -m "chore: mirror m3u8DL-mir source $SOURCE_VALUE ($SHORT_COMMIT)"
git tag -a "mirror-source-$SHORT_COMMIT" -m "Mirror m3u8DL-mir source $SOURCE_VALUE ($SHORT_COMMIT)"
git push origin HEAD
git push origin "mirror-source-$SHORT_COMMIT"
echo "已同步 m3u8DL-mir $UPSTREAM_BRANCH：$UPSTREAM_COMMIT"
